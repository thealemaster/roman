...
START_TEST (passing_NULL_to_subtract_as_first_argument_results_in_error)
{
  int statusReturned;
  char *firstNumeral = '\0', 
    secondNumeral [MAX_ROMAN_NUMERAL_STRING_SIZE] = "VI", 
...
START_TEST (passing_NULL_to_subtract_as_second_argument_results_in_error)
{
  int statusReturned;
  char firstNumeral [MAX_ROMAN_NUMERAL_STRING_SIZE] = "VI", 
    *secondNumeral = '\0', 
...
START_TEST (passing_add_result_size_not_equal_to_MAX_ROMAN_NUMERAL_STRING_SIZE_results_in_error)
{
  int statusReturned;
  char firstNumeral [MAX_ROMAN_NUMERAL_STRING_SIZE] = "VI", 
    secondNumeral  [MAX_ROMAN_NUMERAL_STRING_SIZE] = "V",
  ...
  statusReturned = add_roman_numerals (firstNumeral, secondNumeral, resultNumeral, MAX_ROMAN_NUMERAL_STRING_SIZE-1);
  ck_assert_int_eq (statusReturned, FAILURE);
